...
CREATE TABLE project1.`CanteenType` (
   `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE project1.`Canteen_CanteenType` (
...
CREATE TABLE IF NOT EXISTS project1.`Comment` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS project1.`Order`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE project1.`DishType` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `canteen_id` int(10) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE IF NOT EXISTS project1.`OrderItem`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS project1.`Member`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
